...
public class Posts extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String env = getenv("OPENSHIFT_DATA_DIR");
        
        try(PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(env + "Posts.txt", true)))) 
        {
        out.println(username + "," + content + "," + timeStamp);
        }
        catch (IOException e) 
        {
        }
